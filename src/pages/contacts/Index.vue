								...
								<td class="px-6 py-4 whitespace-nowrap">
									<div class="flex items-center">
										<div class="flex-shrink-0 h-12 w-12">
											<img class="h-12 w-12 rounded-full object-cover group-hover:opacity-75" :src="item.avatar" alt="" v-if="item.avatar" />
											<img class="h-12 w-12 rounded-full object-cover group-hover:opacity-75" :src="`https://images.unsplash.com/photo-1563982277846-1299eec465d3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80`" alt="" v-else />
										</div>
										<div class="ml-4">
		...
		<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
			...
			<div class="mt-2">
				<p class="text-sm text-gray-500">
					Are you sure you want to delete this tag? This data will be permanently removed from our servers forever.
...
import SideForm from '@/components/contacts/SideForm.vue';
...
export default {
	...
	methods: {
		fetchList(isReset = false) {
			...
			contactApi.getList(params, callback, errorCallback);
		},
		setPage(page) {
		...
		approveRemove() {
			...
			contactApi.delete(selectedId, callback, errorCallback);
		},
		onRemove(selectedId) {
