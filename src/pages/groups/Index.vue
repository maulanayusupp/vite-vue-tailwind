								...
								<td class="px-6 py-4 whitespace-nowrap">
									<div class="flex items-center">
										<div class="flex-shrink-0 h-12 w-12">
											<img class="h-12 w-12 rounded-full object-cover group-hover:opacity-75" :src="item.icon" alt="" v-if="item.icon" />
...
import SideForm from '@/components/groups/SideForm.vue';
...
export default {
	...
	methods: {
		...
		approveRemove() {
			...
			groupApi.delete(selectedId, callback, errorCallback);
		},
		onRemove(selectedId) {
