								...
								<td class="px-6 py-4 whitespace-nowrap">
									<div class="flex items-center">
										<div class="flex-shrink-0 h-12 w-12">
											<img class="h-12 w-12 rounded-full group-hover:opacity-75" :src="item.icon" alt="" v-if="item.icon" />
...
import SideForm from '@/components/tags/SideForm.vue';
...
export default {
	...
	methods: {
		fetchList(isReset = false) {
			...
			tagApi.getList(params, callback, errorCallback);
		},
		setPage(page) {
		...
		approveRemove() {
			...
			tagApi.delete(selectedId, callback, errorCallback);
		},
		onRemove(selectedId) {
