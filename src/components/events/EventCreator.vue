					...
					<div class="sm:col-span-2">
						<div class="space-x-3 grid grid-cols-2">
							<div>
								...
								<div class="mt-1">
									<t-input :type="`date`" :value="date" v-model="date" class="w-full" />
								</div>
							</div>
							<div>
								<label for="end_time" class="block text-sm font-medium text-gray-700">End</label>
								<div class="mt-1">
									<t-input :type="`date`" :value="event.end_time" v-model="event.end_time" class="w-full" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="space-y-5 sm:mt-0">
								<div class="relative flex items-start">
									...
									<div class="pl-7 text-sm">
										...
										<p id="public-access-description" class="text-gray-500">Everyone with the link will see this event</p>
									</div>
								</div>
								<div class="relative flex items-start">
									<div class="absolute flex items-center h-5">
									...
									<div class="pl-7 text-sm">
										...
										<p id="private-access-description" class="text-gray-500">
											Only invited users can access this event
										</p>
									</div>
								</div>
							</div>
